...
const ImageWindow: React.FC<ImageWindowProps> = ({
  ...
  return (
    <>
      ...
      <Typography variant="body1">
        <strong>Location:</strong> {selectedImage.address || "No address assigned yet"}
      </Typography>
      <Typography variant="body1">
        <strong>Date Created:</strong> {formatDate(selectedImage.createdAt)}
      </Typography>
      <Typography variant="body1">
        <strong>Date Updated:</strong> {formatDate(selectedImage.updatedAt)}
      </Typography>
      {/* Human Labels */}
