  ...
  return (
    <div>
      <Container maxWidth= 'xl' sx={{pt:4,pb:4}}>
        <Typography variant='h6'align='center'  sx={{ color: "text.primary", mb: 2 }}> Hover over the map to display the percentage of doors marked in a neighborhood<br/>Click within Manhattan to navigate to that location on the Explore page!</Typography>
