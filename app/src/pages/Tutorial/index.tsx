            ...
            <Grid item xs={10}>
              <TabPanel value={value} index={0}>
                <Typography sx={{ mb: 2, textAlign: "left" }}>
                  ...
                  storefronts, you will accrue points. <br />
                  Different action receive a different number of points. Users
                  with the most credits are displayed on the leaderboard.
                  <Typography>
                    {" "}
            ...
            <Grid item xs={10}>
              <TabPanel value={value} index={3}>
                <Typography sx={{ mb: 2, textAlign: "left" }}>
                  ...
                  labeling feature of queried images once they are captured from
                  Google Street View. However, these labels are not always
                  accurate, either some accessibility objects are left out or
                  some are wrongly labeled. To alleviate this, DoorFront offers
                  an additional opportunity for users to validate submitted
                  labels by confirming the bounding boxes locations and labels.
                  <Typography
                    variant="h5"
                  ...
                  navigation bar called "Validate Labels". When you click on the
                  "Validate Labels" button, an interface opens where users can
                  go through the images that have been already labels and
                  submitted. This allows users to look over other users work to
                  fix mistakes they have made or missed. You can also encounter
                  storefronts that have been already collecting while you are
                  exploring the city google street view in DoorFront.
                  <Validate />
                </Typography>
              </TabPanel>
            </Grid>
...
function TabPanel(props: TabPanelProps) {
  ...
  return <div {...other}>{value == index && <h1>{children}</h1>}</div>;
}
